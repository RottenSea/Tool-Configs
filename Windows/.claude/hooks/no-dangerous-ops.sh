...
#
# NOTE: most of these targets (/etc, /proc, systemctl, iptables, crontab -r)
# are Linux/POSIX concepts. On Windows they're effectively inert — harmless,
# but they don't cover Windows-specific hazards (PowerShell Remove-Item,
# diskpart, format, etc.) since this is a Bash-tool hook.
